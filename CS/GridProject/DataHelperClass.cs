...
namespace Helpers
{
    public class DataHelper
    {
        ...
        public DataHelper(DSparameter param)
        {
            switch (param)
            {
        ...
        public static DataTable MakeAdditionalTable()
        {
            DataTable table = new DataTable("FirstTable");
            DataColumn column;
            DataRow row;
        ...
        private void MakeBoolFirstTable()
        {
            ...
            for (int i = 0; i <= 10; i++)
            {
                ...
                row["value1"] = "Item " + i.ToString();
                row["value2"] = false;
                row["value3"] = "Opposite value: " + (!(bool)row["value2"]).ToString();
                table.Rows.Add(row);
            }
        }
        ...
        private void MakeDataRelation2()
        {
            DataColumn parentColumn =
                DataSet.Tables["FirstTable"].Columns["value1"];
            DataColumn childColumn =
            ...
            childColumn =
                DataSet.Tables["ThirdTable"].Columns["value7"];
            relation = new
                DataRelation("value1_value7", parentColumn, childColumn);
            DataSet.Tables["ThirdTable"].ParentRelations.Add(relation);
        }
    ...
    {
        simpleDS = 0, doubleDS = 1, relatedDS1 = 2, simpleBoolDS = 3, simpleTimeDS = 4, relatedDS2 = 5, 
    }
}
